...
DisplayOptionsPanel* DisplayOptionsPanel_new(Settings* settings, ScreenManager* scr) {
   ...
   Panel_add(super, (Object*) NumberItem_newByRef("Keep columns visible (0 - off, 1-5 - number of leading columns kept in view)", &(settings->keepColumnsVisible), 0, 0, MAXIMUM_KEEP_COLUMNS));
